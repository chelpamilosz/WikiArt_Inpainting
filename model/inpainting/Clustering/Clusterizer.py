...
class Clusterizer():
    ...
    def clusterize(self, type, n_clusters, image_features=None):
        if type == 'train':
            ...
            kmeans = load('C:\vscodeProjects\WikiArt_Inpainting\model\inpainting\Models\kmeans_model.pkl')
            ...
            kmeans = load(r'C:\vscodeProjects\WikiArt_Inpainting\model\inpainting\Models\kmeans_model.pkl')
            print("Załadowano model KMeans z: C:\vscodeProjects\WikiArt_Inpainting\model\inpainting\Models\kmeans_model.pkl")
